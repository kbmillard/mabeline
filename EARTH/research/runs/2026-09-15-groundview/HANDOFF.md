...
> **Superseded for full product narrative.** For everything built through P18, use [`BLUEPRINT.md`](./BLUEPRINT.md). This handoff remains a P0–P14-era cloud-architect paste; it does not cover P15–P18 software completion.
