const GEV_REALTIME_TOOLS = [
  {
    ...
    description:
      'Fly the SkyView by SkyPrairie.io camera to a known city, geocoded country/region/city/landmark, or explicit WGS84 coordinate. Countries/cities frame the whole place; landmarks/buildings use close framing.',
    parameters: {
      type: 'object',
  ...
  },
  {
    ...
    description:
      'Enable or disable one registered SkyView by SkyPrairie.io data layer.',
    parameters: {
      type: 'object',
      additionalProperties: false,
      properties: {
  ...
  },
  {
    ...
    description: 'Set the active SkyView by SkyPrairie.io visual filter/style.',
    parameters: {
      type: 'object',
      additionalProperties: false,
      properties: {
